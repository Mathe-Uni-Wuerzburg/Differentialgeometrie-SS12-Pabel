...
\begin{bemerkung} \(\)
 \begin{enumerate}
  \item Erst auf einer \(\C^4\)-Fläche existiert im Allgemeinen eine lokale Krümmungslinien-/Asymptotenlinien-Parametrisierung, mit der sich vernünftig arbeiten lässt.
...
\subsubsection{Die Gaußschen Ableitungsgleichungen}

\begin{align*}
 &\partial_\sigma x_\varrho = \nabla_\sigma x_\varrho + \Rom2(x_\varrho, x_\sigma) N \Rightarrow \\
